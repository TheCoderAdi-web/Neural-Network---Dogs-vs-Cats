NOTE: There is no way to test the neural network. For those who want to use this network, there are no X_train or Y_train variables, you will have to add them yourself.
